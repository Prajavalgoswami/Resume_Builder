...
import { LucideFile, LucideFilePlus } from 'lucide-react'
...
const calculateCompletion = (resume) => {
  ...
  // it will show complete it will do ++.
   ...
   <DashboardLayout >
        ...
        <div className={styles.headerWrapper}>
           ...
           <div >
            ...
            <p className={styles.headerSubtitle}>
              {allResumes.length > 0 ? `you have ${allResumes.length} resumes ${allResumes.length !== 1 ? 's' : ''}` : 'Start building your resume now!'}
              </p>
           </div>
       ...
       {!loading && allResumes.length === 0 && (
         <div className={styles.emptyStateWrapper}>
          ...
          <h3 className={styles.emptyTitle}>No resumes found. Start building your resume now!</h3>
          <p className={styles.emptyText}>Click the button above to create your first resume.</p>
        ...
        <div className='p-4'>
          <div className='flex flex-col items-center text-center'>
            <div className={styles.deleteIconWrapper}>
              <LucideTrash size={32} className='text-red-600' />
            </div>
            <h4 className={styles.deleteTitle}>Are you sure you want to delete this resume?</h4>
            <p className={styles.deleteText}>This action cannot be undone.</p>
          </div>
        </div>
       </Modal>
