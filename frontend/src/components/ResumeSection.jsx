...
export const CertificationInfo = ({ title, issuer, year, bgColor }) => (
  <div className={styles.certContainer}>
    ...
    <div className={styles.certRow}>
      <p className={`${styles.certIssuer} flex-1 text-left`}>{issuer}</p>
      {year && (
        <div className={styles.certYear(bgColor)} style={{ backgroundColor: bgColor }}>
          {year}
        </div>
      )}
    </div>
...
export const ContactInfo = ({ value }) => (
