...
export const dashboardStyles = {
  ...
  inputField: "w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-violet-500 outline-none transition-all duration-200",
...
export const authStyles = {
  ...
  // Login-specific keys used by Login.jsx
  Container: "w-[90vw] md:w-[400px] p-8 bg-gradient-to-br from-white to-violet-50 rounded-3xl",
  loginTitle: "text-2xl font-black text-slate-900 mb-2",
  loginSubtitle: "text-slate-600 font-medium",
  error: "text-red-500 text-sm font-medium bg-red-50 border border-red-200 px-4 py-3 rounded-xl",
  input: "w-full bg-gray-50 border-2 border-gray-300 px-4 py-3 rounded-xl outline-none focus:border-violet-500 focus:ring-4 focus:ring-violet-500/20 transition-all",
  loginButton: "w-full py-3 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-black rounded-2xl hover:scale-105 hover:shadow-xl hover:shadow-violet-200 transition-all",
  signupSwitchButton: "font-black text-violet-600 hover:text-fuchsia-600 transition-colors",
  signupContainer: "w-[90vw] md:w-[400px] p-8 bg-gradient-to-br from-white to-rose-50 rounded-3xl overflow-hidden",
...
export const infoStyles = {
  ...
  certRow: "flex items-center justify-between gap-2 mt-1",
